...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-24 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center">
          <LogIn className="w-12 h-12 text-green-500" />
        </div>
        <h2 className="mt-6 text-center text-3xl font-bold text-gray-900">
          Welcome to NutriExpert
        </h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          Please sign in to access our health and nutrition services
        </p>
      </div>
